...
datePattern = re.compile(r"""^(.*?) # all text before the date
    ...
    ((19|20)\d\d)                   # fourdigits for the year
    (.*?)$  # ALL TEXT after dates
    """, re.VERBOSE)
...
for amerFilename in os.listdir('.'):
    ...
    # Rename the files.
    print('Renaming "%s" to %s"...' % (amerFilenam, euroFIlename))
    #shutil.move(amerFilename, euroFIlenmae) # uncomment after testing
